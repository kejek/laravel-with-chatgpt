@if ($paginator->hasPages())
    <nav
        class="flex items-center justify-between border-t border-base-content/50 px-4 py-3 sm:px-6"
        role="navigation"
        ...
        <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            ...
            <div>
                <span class="join relative z-0 inline-flex shadow-sm">
                    ...
                    @if ($paginator->onFirstPage())
                        <span
                            class="btn-disabled join-item btn"
                            aria-disabled="true"
                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span
                                        class="btn-disabled btn-active join-item btn"
                                        aria-current="page"
                                    >
                                        {{ $page }}
                                    </span>
